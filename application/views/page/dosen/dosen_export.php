<?php 
	...
	//name the worksheet
	$this->excel->getActiveSheet()->setTitle('Data Dosen');

	//set cell A1 content with some text
	$this->excel->getActiveSheet()->setCellValue('A1', 'Daftar Dosen STMIK MAHAKARYA');
	...
	$filename='daftar_dosen.xls'; //save our workbook as this file name
	...
	foreach ($data as $key => $value) {
		...
		$this->excel->getActiveSheet()->setCellValueByColumnAndRow(1, $row, $value['nama_dosen']); 
