            ...
            <form action="<?php echo base_url('proses/simpan_jadwal'); ?>" method="post">
              ...
              <div class="nav-tabs-custom">
                <ul class="nav nav-tabs pull-right">
                  <li class="active"><a href="#redips-drag" data-toggle="tab">Hasil Generate</a></li>
                  <li class="pull-left header"><i class="fa fa-th"></i> Jadwal</li>
                </ul>
                <div class="tab-content">
                  <div class="tab-pane active" id="redips-drag">
                    ...
                    <div class="row">
                      <div class="col-md-12">     
                          ...
                          <?php foreach ($data_hari as $k_hari => $hari): ?>
                            <table border="1" class="table table-bordered text-center" id="table<?php echo $hari['id_hari']; ?>">
                                ...
                                <tr>
                                  ...
                                  <?php foreach ($data_ruang as $k_ruang => $ruang): ?>
                                    ...
                                    <td width="10%" style="vertical-align:middle;">
                                      <?php $data = $jadwal[($hari['id_hari']-1)][($sesi['id_sesi']-1)][($ruang['id_ruang']-1)]; ?>
                                      <div id="d<?php echo ($data['id_ajar']); ?>" class="redips-drag t<?php echo $hari['id_hari']; ?>" style="border:0px solid white;width:125px;<?php echo ($data['status']>0) ? 'color:red' : ''; ?>;" >
